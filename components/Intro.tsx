  ...
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
      ...
      >
        ...
        <a className="bg-white p-4 gap-2 text-gray-700 flex items-center rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer border border-black/10">
          <BsLinkedin />
        </a>
        <a className="bg-white p-4 gap-2 text-[1.35rem] flex items-center rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer border border-black/10">
          <FaGithubSquare />
        </a>
      </motion.div>
    </section>
